...
requireConfidentialDocumentStepUp($documentId, $versionId, $user, 'view');
...
if (strtoupper((string) ($file['confidentiality_level'] ?? '')) === 'CONFIDENTIAL') {
    documentStepUpService()->auditDocumentAccess('CONFIDENTIAL_DOCUMENT_VIEWED', $user, $documentId, (int) $file['document_version_id']);
}
