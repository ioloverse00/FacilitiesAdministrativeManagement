...
try {
    ...
    $result = legalMatterPartyService()->dismissParty($matterId, $partyId, readJsonBody(), $user);
    if ($result === null) {
        jsonResponse(false, 'Party not found.', [], 404);
    }
    jsonResponse(true, 'Party dismissed.', ['item' => legalMatterService()->show($matterId)], 200);
} catch (Throwable $e) {
