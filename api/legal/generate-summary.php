...
try {
    ...
    jsonResponse(true, legalSummaryMessage($details, 'generated'), ['item' => $details, 'ai_summary_status' => $details['aiSummaryStatus'] ?? 'FAILED', 'ai_summary_failure_reason' => $details['aiSummaryFailureReason'] ?? ''], 200);
} catch (Throwable $e) {
